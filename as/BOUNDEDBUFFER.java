...
import generatedbyassl.as.boundedbuffer.controlloop.*;

/**
 * Generated by ASSL Framework
 * 
 * This is the Java class generated for 'BoundedBuffer' (specified as AS ASSL tier).
 */
	...
	extends Thread
{
	 ...
	 * Generated by ASSL Framework
	 * 
	 * This is a reference to the unique instance of 'BOUNDEDBUFFER' class.
	 */
	static private BOUNDEDBUFFER oInstance = null;
	/**
	 * Generated by ASSL Framework
	 * 
	 * Holds pairs 'SLO name'-'SLO reference' of all the SLOs specified by BOUNDEDBUFFER.
	 */
	public Hashtable<String, ASSLSLO> ASSLO = new Hashtable<String, ASSLSLO>();
	/**
	 * Generated by ASSL Framework
	 * 
	 * Holds pairs 'policy name'-'policy reference' of all the self-management policies followed by BOUNDEDBUFFER.
	 */
	private Hashtable<String, ASSLPOLICY> vPolicies = new Hashtable<String, ASSLPOLICY>();
	/**
	 * Generated by ASSL Framework
	 * 
	 * Holds pairs 'AE name'-'AE reference' of all the autonomic elements specified by BOUNDEDBUFFER.
	 */
	public Hashtable<String, ASSLAE> AES = new Hashtable<String, ASSLAE>();
	/**
	 * Generated by ASSL Framework
	 * 
	 * Holds pairs 'action name'-'action reference' of all the actions specified by BOUNDEDBUFFER.
	 */
	public Hashtable<String, ASSLACTION> ACTIONS = new Hashtable<String, ASSLACTION>();
	/**
	 * Generated by ASSL Framework
	 * 
	 * Holds pairs 'event name'-'event reference' of all the events specified by BOUNDEDBUFFER.
	 */
	public Hashtable<String, ASSLEVENT> EVENTS = new Hashtable<String, ASSLEVENT>();
	/**
	 * Generated by ASSL Framework
	 * 
	 * Holds pairs 'metric name'-'metric reference' of all the metrics specified by BOUNDEDBUFFER.
	 */
	 ...
	 * Generated by ASSL Framework
	 * 
	 * Holds a reference to the BOUNDEDBUFFER control loop's monitor.
	 */
	private BOUNDEDBUFFER_ASSLMONITOR oMonitor = new BOUNDEDBUFFER_ASSLMONITOR();
	/**
	 * Generated by ASSL Framework
	 * 
	 * Holds a reference to the BOUNDEDBUFFER control loop's analyzer.
	 */
	private BOUNDEDBUFFER_ASSLANALYZER oAnalyzer = new BOUNDEDBUFFER_ASSLANALYZER();
	/**
	 * Generated by ASSL Framework
	 * 
	 * Holds a reference to the BOUNDEDBUFFER control loop's simulator.
	 */
	private BOUNDEDBUFFER_ASSLSIMULATOR oSimulator = new BOUNDEDBUFFER_ASSLSIMULATOR();
	/**
	 * Generated by ASSL Framework
	 * 
	 * Holds a reference to the BOUNDEDBUFFER control loop's executor.
	 */
	private BOUNDEDBUFFER_ASSLEXECUTOR oExecutor = new BOUNDEDBUFFER_ASSLEXECUTOR();
	/**
	 * Generated by ASSL Framework
	 * 
	 ...
	 */
	public generatedbyassl.as.boundedbuffer.ASARCHITECTURE ASARCHITECTURE = generatedbyassl.as.boundedbuffer.ASARCHITECTURE.getInstance();
	...
	{
		vPolicies.put( "SELF_HEALING", generatedbyassl.as.boundedbuffer.asself_management.SELF_HEALING.getInstance() );
		ACTIONS.put( "NOTIFY", generatedbyassl.as.boundedbuffer.actions.NOTIFY.getInstance() );
		EVENTS.put( "BUFFERFULL", generatedbyassl.as.boundedbuffer.events.BUFFERFULL.getInstance() );
		EVENTS.put( "NOTIFIED", generatedbyassl.as.boundedbuffer.events.NOTIFIED.getInstance() );
		AES.put( "BUFFER", generatedbyassl.as.aes.BUFFER.getInstance() );
		AES.put( "CONSUMER", generatedbyassl.as.aes.CONSUMER.getInstance() );
		AES.put( "PRODUCER", generatedbyassl.as.aes.PRODUCER.getInstance() );
	}

	/**
	 * Generated by ASSL Framework
	 * 
	 * This method returns the unique instance of 'BOUNDEDBUFFER' class.
	 */
	static public BOUNDEDBUFFER getInstance (  )
	{
		if ( null == oInstance ) 
		{
			oInstance = new BOUNDEDBUFFER();
		}
		return oInstance;
	}
	 ...
	 * Generated by ASSL Framework
	 * 
	 * This method applies all the policies specified by BOUNDEDBUFFER.
	 */
	 ...
	 * Generated by ASSL Framework
	 * 
	 * Creates and runs BOUNDEDBUFFER.
	 */
	public static void main ( String[] args )
	{
		BOUNDEDBUFFER oANTS = BOUNDEDBUFFER.getInstance();
		System.out.println( "**********************************************************" );
