package generatedbyassl.as.boundedbuffer;
	...
	implements  Serializable
{
	...
	private  ASARCHITECTURE (  )
	{
		...
		//**** adds AELIST
		AELIST.put( "BUFFER", generatedbyassl.as.aes.BUFFER.getInstance() );
		AELIST.put( "PRODUCER", generatedbyassl.as.aes.PRODUCER.getInstance() );
		AELIST.put( "CONSUMER", generatedbyassl.as.aes.CONSUMER.getInstance() );
		//**** adds GROUPS
		oGROUP = new ASSLGROUP( "BUFFERGROUP" );
		oGROUP.addToMembers( "BUFFER", generatedbyassl.as.aes.BUFFER.getInstance() );
		oGROUP.addToMembers( "PRODUCER", generatedbyassl.as.aes.PRODUCER.getInstance() );
		oGROUP.addToMembers( "CONSUMER", generatedbyassl.as.aes.CONSUMER.getInstance() );
		GROUPS.put( "BUFFERGROUP", oGROUP );
	}
