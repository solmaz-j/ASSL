package generatedbyassl.as.boundedbuffer.asself_management;
	...
	implements  Serializable
{
	...
	{
		vFluents.put( "INBUFFERFULL", generatedbyassl.as.boundedbuffer.asself_management.self_healing.INBUFFERFULL.getInstance() );
	}
	...
	{
		//************************ MAPPING ***********************
		if ( generatedbyassl.as.boundedbuffer.asself_management.self_healing.INBUFFERFULL.getInstance().isFluentInitiated() ) 
		{
			...
			Runnable actionsRunner = new Runnable()
			{
				...
				public void run (  )
				{
					try
					{
						generatedbyassl.as.boundedbuffer.actions.NOTIFY.getInstance().perform(  );
					}
					catch ( Exception ex ) 
					{
