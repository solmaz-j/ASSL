package generatedbyassl.as.aes.consumer.aeself_management;
	...
	implements  Serializable
{
	...
	{
		vFluents.put( "INRECEIVING", generatedbyassl.as.aes.consumer.aeself_management.self_healing.INRECEIVING.getInstance() );
	}
	...
	{
		//************************ MAPPING ***********************
		if ( generatedbyassl.as.aes.consumer.aeself_management.self_healing.INRECEIVING.getInstance().isFluentInitiated() ) 
		{
			...
			Runnable actionsRunner = new Runnable()
			{
				...
				public void run (  )
				{
					try
					{
						generatedbyassl.as.aes.consumer.actions.SEND.getInstance().perform(  );
					}
					catch ( Exception ex ) 
					{
			...
			if ( !isMappingRunning( "INRECEIVING" ) ) 
			{
				Thread runActions = new Thread(thrdgrMappings, actionsRunner, "INRECEIVING");
				runActions.start();
			}
		}
	}
