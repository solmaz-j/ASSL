package generatedbyassl.as.aes.consumer;
	...
	implements  Serializable
{
	...
	private  AEIP (  )
	{
		MESSAGES.put( "GETREQUEST", generatedbyassl.as.aes.consumer.aeip.messages.GETREQUEST.getInstance() );
		CHANNELS.put( "CONSUMERTOBUFFER", generatedbyassl.as.aes.consumer.aeip.channels.CONSUMERTOBUFFER.getInstance() );
		FUNCTIONS.put( "SENDPUTREQUEST", generatedbyassl.as.aes.consumer.aeip.functions.SENDPUTREQUEST.getInstance() );
		MANAGED_ELEMENTS.put( "CONSUMER", generatedbyassl.as.aes.consumer.aeip.managed_elements.CONSUMER.getInstance() );
	}
